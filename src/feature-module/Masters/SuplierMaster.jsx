...
const SuplierMaster = () => {
    ...
    useEffect(() => {
        const handleShortcut = (e) => {
            if (e.ctrlKey && e.key === 'a') {
                e.preventDefault();
                navigate(route.AddSuplierMaster);
            }
    ...
    const onEditClick = (caid) => {
        navigate(route.AddSuplierMaster, { state: { SCAID: caid } });
    };
    const columns = [
        {
            title: "नाव",
                ...
                <div className="page-header">
                    <div className="add-item d-flex">
                        <div className="page-title">
                            <h3>पुरवठादार मास्टर</h3>
                            <h6>पुरवठादार व्यवस्थापित करा</h6>
                    ...
                    <div className="page-btn">
                        <Link to={route.AddSuplierMaster} className="btn btn-added">
                            <PlusCircle className="me-2 iconsize" /> कस्टमर नोंदवा
                        </Link>
                    </div>
                    <div className="page-btn">
