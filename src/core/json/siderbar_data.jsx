...
export const SidebarData = [
  ...
  },
  {
    ...
    submenuHdr: "FarmerBill",
    submenuItems: [
      {
        label: "Farmer Bill",
        link: "/MarketBillIndex",
        submenu: true,
        showSubRoute: false,
        icon: (
          <i
  ...
  },
  {
    ...
    submenuHdr: "Transporter",
    submenuItems: [
      {
        label: "Transporter",
        link: "/TranporterIndex",
        submenu: true,
        showSubRoute: false,
        icon: (
          <i
            className="bi bi-people-fill me-2"
            data-bs-toggle="Transporter"
            title="ri-settings-5-line"
          />),
        submenuItems: [
          {
  ...
  //       icon: (
  //         <i
  //           className="bi bi-database-fill me-2"
  //           data-bs-toggle="Master"
  //           title="ri-settings-5-line"
  //         />),
  //       submenuItems: [
