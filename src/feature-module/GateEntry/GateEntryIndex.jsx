...
function GateEntryIndex() {
    ...
    const cardsData = [
        { title: 'प्रवेशद्वार', image: 'assets/img/avatar/checkpoint.png', path: '/GateEntry' },
        { title: 'शेतकरी नोंदणी', image: 'assets/img/avatar/farmer.png', path: '/QuickFarmer' },
        { title: 'वाहन चालक नोंदणी ', image: 'assets/img/avatar/container.png', path: '/QuickTransporter' },
    ];
    return (
