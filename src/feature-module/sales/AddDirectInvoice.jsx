    ...
    const checkFormValidity = (e) => {
        ...
        if (!VBILLNO || !/^[a-zA-Z0-9]+$/.test(VBILLNO)) {
            Swal.fire({
                icon: "error",
                title: "Validation Error",
                text: "VBILLNO मध्ये केवळ अक्षरे आणि संख्या असाव्यात.",
            }).then(() => {
                setTimeout(() => {
        ...
        if (!SBTERMANDCONDITION || SBTERMANDCONDITION.trim() === "") {
            Swal.fire({
                icon: "error",
                title: "Validation Error",
                text: "कृपया अटी व शर्ती प्रविष्ट करा.",
            }).then(() => {
                setTimeout(() => {
        ...
        //     icon: "error",
        //     title: "Validation Error",
        //     text: "कृपया टिप्पणी प्रविष्ट करा.",
        //   }).then(() => {
        //     setTimeout(() => {
                    ...
                    <div className="modal-content">
                        <div className="page-wrapper-new p-0">
                                ...
                                <div className="modal-body custom-modal-body" style={{
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="row ">
                                            <div className="col-lg-2 col-md-3 col-12">
                                                <div className="mb-0 add-product form-label">
                                                    <label className=" required ">ग्राहक बिल क्रमांक</label>
                                                    <input
                                                        type="text"
                                                        className="form-control border"
                                                        ref={VBILLNORef}
                                                        ...
                                                        onChange={handleInputChange}
                                                        title="कृपया वैध क्रमांक प्रविष्ट करा"
                                                        required
                                                    />
                                                </div>
                                            ...
                                            <div className="col-lg-2 col-md-3 col-12">
                                                <div className="mb-0 add-product form-label">
                                                    <label className=" required ">भरणा पद्धती</label>
                                                    <Select
                                                        classNamePrefix="react-select"
                                                        options={paymentmode}
                                                        placeholder="Choose"
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="row">
                                                <div className="col-lg-8 col-md-12 col-sm-12 ">
                                                    <div className="mb-0 add-product form-label">
                                                        <label className=" required">नियम व अटी</label>
                                                        <textarea
                                                            type="text"
                                                            className="form-control border "
                          ...
                          <div className="addproduct-icon">
                            <h5>
                              <span>भरण्याचा तपशील :</span>
                            </h5>
                          </div>
                      
                          <div className="col-lg-3 col-sm-6 col-12">
                              <div className="mb-0 add-product form-label">
                                  <label>भरणा देय तारीख</label>
                                  <input
                                      type="text"
                                      className="form-control border"
                                      placeholder="select"
                          ...
                          <div className="col-lg-12 col-md-12 col-sm-12 ">
                              <div className="mb-0 add-product form-label">
                              <label className=" required">वर्णन</label>
                              <input 
                                ref={SBNARRATIONRef}
                                type="text"
                                className="form-control border"
