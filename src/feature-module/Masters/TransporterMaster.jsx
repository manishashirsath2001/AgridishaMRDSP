...
const TransporterMaster = () => {
    ...
    useEffect(() => {
        const handleShortcut = (e) => {
            if (e.ctrlKey && e.key === 'a') {
                e.preventDefault();
                navigate(route.AddTransporterMaster);
            }
    ...
    const onEditClick = (caid) => {
        navigate(route.AddTransporterMaster, { state: { CAID: caid } });
    };
    const columns = [
        {
            title: "नाव",
                ...
                <div className="page-header">
                    <div className="add-item d-flex">
                        <div className="page-title">
                            <h3>वाहक मास्टर व्यवस्थापन</h3>
                            {/* <h6>Manage Transporter</h6> */}
                        </div>
                    </div>
                    ...
                    <div className="page-btn">
                        <Link to={route.AddTransporterMaster} className="btn btn-added">
                            <PlusCircle className="me-2 iconsize" /> वाहक नोंदवा
                        </Link>
                    </div>
                    <div className="page-btn">
