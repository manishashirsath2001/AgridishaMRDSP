...
function VyapariIndex() {
    ...
    const cardsData = [
        { title: 'व्यापारी नोंदणी ', image: 'assets/img/avatar/register.png', path: '/Vyapari' },
        { title: 'व्यापारी लिमिट नोंदणी', image: 'assets/img/avatar/limit.png', path: '/Vyaparilimit' },
        // { title: 'व्यापरी बिल', image: 'assets/img/avatar/billF.png', path: '/VyapriBillMaster' },
    ];
    return (
