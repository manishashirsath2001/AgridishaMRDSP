    ...
    const checkFormValidity = (e) => {
        ...
        if (!VBILLNO || !/^[a-zA-Z0-9]+$/.test(VBILLNO)) {
            Swal.fire({
                icon: "error",
                title: "Validation Error",
                text: "VBILLNO मध्ये फक्त अक्षरे आणि संख्या असाव्यात.",
            }).then(() => {
                setTimeout(() => {
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="row">
                                            ...
                                            <div className="col-lg-2 col-md-3 col-12">
                                                <div className="mb-0 add-product form-label">
                                                    <label className="required">वाहतुकदार</label>
                                        ...
                                        <div className="row ">
                                            <div className="col-lg-2 col-md-3 col-12">
                                                <div className="mb-0 add-product form-label">
                                                    <label className=" required ">ग्राहक क्रमांक</label>
                                                    <input
                                                        type="text"
                                                        className="form-control border"
                                                        ref={VBILLNORef}
                                        ...
                                        <div className="row">
                                                                    ...
                                                                    <table className="table table-bordered">
                                                                        <thead className="thead-dark">
                                                                            <tr>
                                                                                ...
                                                                                <th className="col-1">कालबाह्यता तारीख</th>
                                            ...
                                            <div className="row">
                                                <div className="col-lg-8 col-md-12 col-sm-12 ">
                                                    <div className="mb-0 add-product form-label">
                                                        <label className=" required">अटी आणि शर्ती</label>
                                                        <textarea
                                                            type="text"
                                                            className="form-control border "
