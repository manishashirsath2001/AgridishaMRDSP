...
function SalesIndex() {
    ...
    const cardsData = [
        { title: 'Requisition', image: 'assets/img/avatar/requisition.png', path: '/SalesEnquiry' },
        { title: 'Quotation', image: 'assets/img/avatar/quotation.png', path: '/QuotationIndex' },
        { title: 'Challan', image: 'assets/img/avatar/challan.png', path: '/SChallanIndex' },
        { title: 'Bill', image: 'assets/img/avatar/bill.png', path: '/BillIndex' },
        { title: 'Return', image: 'assets/img/avatar/return.png', path: '/SalesRetunMaster' },
