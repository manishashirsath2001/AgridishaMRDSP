...
import AddKharchVoucher from "./AddKharchVoucher";
// import KharchVoucher from "./kharchVoucher";
...
const KharchVoucher = () => {
    ...
    useEffect(() => {
        const handleShortcut = (e) => {
            if (e.ctrlKey && (e.key === "a" || e.key === "A")) {
                e.preventDefault();
                const modalTrigger = document.querySelector('[data-bs-target="#add-kharch"]');
                if (modalTrigger) {
                    modalTrigger.click();
                }
            }
    ...
    return (
        <div className="page-wrapper">
                ...
                <div className="page-header">
                    <div className="add-item d-flex">
                        <div className="page-title">
                            <h3>खर्च व्हाउचर मास्टर </h3>
                            <h6>खर्च व्हाउचर व्यवस्थापित करा</h6>
                        </div>
                    </div>
            ...
            <AddKharchVoucher voucherAID={selectedData.voucherAID} onRefresh={refreshData} />

        </div>
    );
};

export default KharchVoucher;
