...
export const all_routes = {
  ...
  MarketBillIndex: '/MarketBillIndex',
  FarmerBillMaster: '/FarmerBillMaster',
  QuickFarmer: '/QuickFarmer',
  QuickTransporter: '/QuickTransporter',
  Auction: '/Auction',
  AddAuction: '/AddAuction',
  AuctionIndex: '/AuctionIndex',
  GateEntry: '/GateEntry',
  AddGateEntry: '/AddGateEntry',
  GateEntryIndex: '/GateEntryIndex',
  Shop: '/Shop',
  AddShop: '/AddShop',
  AddLeger: '/AddLeger',
  VyapariIndex: '/VyapariIndex',
  Vyapari: '/Vyapari',
  AddVyapari: '/AddVyapari',
  ServiceCharges: '/ServiceCharges',
  Transporter: '/Transporter',
  AddTransporter: '/AddTransporter',
  TranporterIndex: '/TranporterIndex',
  Farmers: '/Farmers',
  AddFarmers: '/AddFarmers',
  CropPlot: '/CropPlot',
  AddCropPlot: '/AddCropPlot',
  FarmerIndex: '/FarmerIndex',
  Leger: '/Leger',
  LegerIndex: '/LegerIndex',
  QuatationMaster_1: "/QuatationMaster_1",
  ...
  BomPacking: '/BomPacking',
  AddBOMPacking: '/AddBOMPacking',
  AddCounter: '/AddCounter',
  Counter: '/Counter',
  AddCompany: '/AddCompany',
  CompanyMaster: '/CompanyMaster',
  HrmIndex: '/HrmIndex',
  SalesRetunMaster: '/SalesRetunMaster',
  SalesReturn: '/SalesReturn',
  BillIndex: '/BillIndex',
  ChallanInvoice: '/ChallanInvoice',
  SaleInvoice: '/SaleInvoice',
  Picksalechallan: '/Picksalechallan',
  Directsalechallan: '/Directsalechallan',
  SChallanIndex: '/SChallanIndex',
  AddSaleQuotation: '/AddSaleQuotation',
  QuotationMaster: '/QuotationMaster',
  PickupQuotationMaster: '/PickupQuotationMaster',
  QuotationIndex: '/QuotationIndex',
  SalesEnquiry: '/SalesEnquiry',
  SalesIndex: '/SalesIndex',
  InvoiceReturn: '/InvoiceReturn',
  PickupChallan: '/PickupChallan',
  DirectChallan: '/DirectChallan',
  ChallanReturn: '/ChallanReturn',
  ReturnIndex: '/ReturnIndex',
  ChallanIndex: '/ChallanIndex',
  ClosePurchaseOrder: "/ClosePurchaseOrder",
  PurchaseReturn: "/PurchaseReturn",
  GoodReciptNote: "/GoodReciptNote",
  ...
  QuatationMaster: '/QuatationMaster',
  AddPurchaseChallanMaster: '/AddPurchaseChallanMaster',
  AddPurchaseInvoice: '/AddPurchaseInvoice',
  PurchaseBill: '/PurchaseBill',
  VendorMaster: '/VendorMaster',
  AddVendorMaster: '/AddVendorMaster',
  SuplierMaster: '/SuplierMaster',
  AddSuplierMaster: '/AddSuplierMaster',
  AddTransporterMaster: '/AddTransporterMaster',
  TransporterMaster: '/TransporterMaster',
  MasterIndex: "/MasterIndex",
  AddAccessRight: "/AddAccessRight",
  AddUserMaster: "/AddUserMaster",
  Inventory: "/Inventory",
  ...
  WareHousesMaster: "/WareHousesMaster",
