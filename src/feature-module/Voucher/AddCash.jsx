...
const AddCash = ({ ACTIVETAB, onRefresh, onClose, TOTALAMOUNT }) => {

    console.log('ACTIVETABACTIVETABACTIVETABACTIVETABACTIVETAB  ', ACTIVETAB)
        ...
        if (ACTIVETAB === 'nav-products-justified') {
            ...
            if (finalTotal > TOTALAMOUNT) {
                Swal.fire({
                    icon: 'warning',
                    title: 'जास्त रक्कम',
                    text: 'एकूण रक्कम ही एकूण जमा रकमेपेक्षा जास्त आहे.',
                    confirmButtonText: 'ठीक आहे',
                });
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    if (summaryResponse.status === 200) {
                        Swal.fire({
                            icon: 'success',
                            title: 'यशस्वीपणे रोख रक्कम डेबिट केली!',
                            text: 'रोख रक्कम यशस्वीपणे डेबिट केली गेली आहे.',
                            confirmButtonText: 'ठीक आहे',
                        }).then(() => {
                            onClose({
                                success: true,
