...
const PickupChallan = () => {
    ...
    const [selectedData, setSelectedData] = useState({ vendorid: null, pcaid: null, statusID: "2" });
    const statusID = "2";
    ...
    const [selectedData1, setSelectedData1] = useState({ pcaidd: null });
    const openModal1 = (pcaidd) => {
        setSelectedData1({ pcaidd })
    }

    // const columns = [
    //     {
    //         title: (
    //             <OverlayTrigger placement="top" overlay={<Tooltip id="Member_Name-tooltip">Challan No</Tooltip>}>
    ...
    //     {
    //         title: (
    //             <OverlayTrigger placement="top" overlay={<Tooltip id="Member_Cantact-tooltip">Challan Date</Tooltip>}>
    ...
    //     {
    //         title: (
    //             <OverlayTrigger placement="top" overlay={<Tooltip id="Member_Cantact-tooltip">Place of Supply</Tooltip>}>
    ...
    //     {
    //         title: (
    //             <OverlayTrigger placement="top" overlay={<Tooltip id="Member_Email-tooltip">Vendor Name</Tooltip>}>
    ...
    //                         to="#"
    //                         data-bs-toggle="modal"
    //                         onClick={() => openModal(record.pcaid, record.pcseller)}
                    ...
                    <div className="edit-delete-action">
                        ...
                        >
                            <Link className="me-2 p-2"
                                ...
                                data-bs-target="#EditPurchasechallan">
                                <Edit className="feather-edit"
                                    onClick={() => openModal1(record.pcaid)} />
                            </Link>
                        </OverlayTrigger>
                        <OverlayTrigger
                            placement="top"
    ...
    const OndeletePurchaseChallan = async (pcaid) => {
        try {
            ...
            // Fetch updated purchase challan data
            try {
                ...
                console.error("Error fetching updated purchase challan data:", error);
            }
