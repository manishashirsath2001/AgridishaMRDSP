                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="row">
                                            <div className="col-lg-2 col-sm-6 col-12">
                                                <div className="mb-0">
                                                    <label className="form-label required">रिक्विसिशन क्रमांक</label>
                                                    <input
                                                        type="text"
                                            ...
                                            <div className="col-lg-2 col-sm-6 col-12">
                                                <div className="mb-0">
                                                    <label className="form-label required">रिक्विसिशन तारीख</label>
                                                    <input
                                                        type="date"
                                                        className="form-control"
                                            ...
                                            <div className="col-lg-3 col-sm-6 col-12">
                                                <div className="mb-0">
                                                    <label className="form-label">श्रेणी/वर्ग</label>
                                                    <Select
                                            ...
                                            <div className="col-lg-3 col-sm-6 col-12">
                                                <div className="mb-0">
                                                    <label className="form-label required">ग्राहकाचे नाव</label>
                                                    <Select
                                                        classNamePrefix="react-select"
                                                        options={vendor}
                                        ...
                                        <div className="border p-3 rounded shadow-sm mb-4">
                                            ...
                                            <div className="addservice-info">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-8 col-sm-6 col-12">
                                                        <div className="mb-0">
                                                            <label className="form-label required">उत्पादनाचे वर्णन</label>
                                                            <input
                                                                type="text"
                                                                className="form-control"
                                                                name="description"
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-2 col-sm-6 col-12">
                                                <div className="mb-0">
                                                    <label className="form-label">बैठक तारीख </label>
                                                    <input
                                                        type="date"
                                                        className="form-control"
                                                        id="meetingdate"
                                            ...
                                            <div className="col-lg-8 col-sm-6 col-12">
                                                <div className="mb-3">
                                                    ...
                                                    <input
                                                        ...
                                                        title="अटी व शर्ती प्रविष्ट करा."
