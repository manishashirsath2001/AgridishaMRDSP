                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="row mb-0 ">
                                            <div className="col-lg-1 col-md-2 col-12  ">
                                                <div>
                                                    <label className="form-label ">Qua No:</label>
                                                    <input
                                                        name="SQNO"
                                                        type="number"
                                                        ...
                                                        >
                                                            <table className="table table-bordered">
                                                                <thead className="thead-dark">
                                                                    <tr>
                                                                        <th className="col-3" style={{ position: 'sticky', top: 0 }}>Product</th>
                                                                        <th className="col-1" style={{ position: 'sticky', top: 0 }}>HSN Code</th>
                                                                        <th className="col-1" style={{ position: 'sticky', top: 0 }}>UOM</th>
                                                                        <th className="col-1" style={{ position: 'sticky', top: 0 }}>Quantity</th>
                                                                        <th className="col-1" style={{ position: 'sticky', top: 0 }}>Rate</th>
                                                                        <th className="col-1" style={{ position: 'sticky', top: 0 }}>Taxable Value</th>
                                                                        ...
                                                                        <th className="col-1" style={{ position: 'sticky', top: 0 }}>Total</th>
                                                                        <th className="col-1" style={{ position: 'sticky', top: 0 }}>Action</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
