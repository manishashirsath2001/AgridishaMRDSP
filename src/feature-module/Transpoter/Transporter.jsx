...
const Transporter = () => {
    ...
    const onEditClick = (taid) => {
        navigate(route.AddTransporter, { state: { TAID: taid } });
    };
        ...
        try {
            ...
            axios({
                ...
                .then((response) => {
                    if (response.status != 200) throw new Error("Failed to Fetching Data");
                    MySwal.fire({
                        title: response.data[0].responseCode === "FAILURE" ? "हटविणे शक्य नाही" : "हटविले गेले!",
                        text: response.data[0].responseMessage,  // तुम्ही दोन्ही वेळेस सारखाच वापरताय, मग थेट वापरा.
    ...
    const handleSearch = (event) => {
        ...
        try {
            ...
            axios({
                method: "POST",
                url: baseUrl.Url + "/backend/api/GET_Transporters/_Search",
                data: JSON.stringify(payload),
                headers: headers,
            })
                .then((response) => {
            ...
            <div className="content">
                <div className="page-header">
                    ...
                    <div className="page-btn">
                        <Link to={route.AddTransporter} className="btn btn-added">
                            <PlusCircle className="me-2 iconsize" /> नवीन
                        </Link>
                    </div>
                    <div className="page-btn">
                        <Link to={route.TranporterIndex} className="btn btn-secondary">
