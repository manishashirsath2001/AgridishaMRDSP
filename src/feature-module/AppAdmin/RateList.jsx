...
const RateList = () => {
    ...
    const [RateList, setAddRateList] = useState([]);
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [previewFileUrl, setPreviewFileUrl] = useState(null);

    const onEditClick = (rid) => {
        navigate(route.AddRateList, { state: { rid: rid } });
    };
                ...
                <div className="action-table-data">
                    <div className="edit-delete-action">
                        <OverlayTrigger placement="top" overlay={<Tooltip id="edit-tooltip">Edit</Tooltip>}>
                            <a className="me-2 p-2" onClick={() => onEditClick(record.rid)}>
    ...
    const OndeleteAccounts = async (rid) => {
        try {
            const payload = {
                rid: rid,
                companyid: "",
            ...
            const response = await axios.post(
                `${baseUrl.Url}/api/SP_DeleteRateList`,
                payload,
                { headers }
            );
            ...
            setAddRateList((prevState) => prevState.filter((item) => item.rid !== rid));
        } catch (error) {
    ...
    const showConfirmationAlert = (rid) => {
        MySwal.fire({
            title: "Are you sure?",
                ...
                <div className="page-header">
                    <div className="add-item d-flex">
                        <div className="page-title">
                            <h3>भाव सूची मास्टर</h3>
                        </div>
                    </div>
                    <ul className="table-top-head">
                        <li>
                            <OverlayTrigger placement="top" overlay={renderTooltip}>
                                <Link onClick={() => generatePDF(RateList)}>
                        ...
                        <li>
                            <OverlayTrigger placement="top" overlay={renderExcelTooltip}>
                                <Link onClick={() => exportToExcel(RateList)}>
                    ...
                    <div className="page-btn">
                        <Link to={route.AddRateList} className="btn btn-added">
                            <PlusCircle className="me-2 iconsize" /> नवीन भाव सूची
                        </Link>
                    </div>
                    <div className="page-btn">
                ...
                <div className="card table-list-card">
                    <div className="card-body">
                        <div className="table-responsive">
                            <Table columns={columns} dataSource={RateList} />
                        </div>
                    </div>
                </div>
