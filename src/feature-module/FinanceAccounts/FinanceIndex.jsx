...
function FinanceIndex() {
    ...
    const cardsData = [
        { title: 'खर्च', image: 'assets/img/avatar/kharcha.png', path: '/expense-list' },
        { title: 'खर्च वर्ग ', image: 'assets/img/avatar/expensec.png', path: '/expense-category' },
        { title: 'बँक माहिती ', image: 'assets/img/avatar/bankinfo.png', path: '/BankDetails' },
        { title: 'कॅश भरणा ', image: 'assets/img/avatar/cashcounter.png', path: '/CashInvert ' },
    ];
