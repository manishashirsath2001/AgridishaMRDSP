                                        ...
                                        {tabledata.length > 0 ? (
                                            tabledata.map((row, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="text-center" style={{ color: '#333' }}>
                                                        <strong>{Math.round(Number(row.weight))}</strong>
                                                    </td>
                                                    <td className="text-center" style={{ color: '#333' }}>
                                                        <strong>{Math.round(Number(row.rate))}</strong>
                                                    </td>

                                                    {/* <td className="text-end" style={{ color: '#333' }}><strong>{row.amount}</strong></td> */}
                                                    <td className="text-end" style={{ color: '#333' }}>
                                                        <strong>{Math.round(Number(row.amount))}</strong>
                                                    </td>
                                                ...
                                                <table className="table-borderless w-100 table-fit">
                                                    <tbody>
                                                        ...
                                                        {Services
                                                            ...
                                                            .map((item, index) => {
                                                                const roundedValue = Math.round(Number(item.sevaValue)) || 0;
                                                                return (
                                                                    <tr key={index}>
