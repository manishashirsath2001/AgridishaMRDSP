...
const Annexure = () => {
    ...
    const onEditClick = (aid) => {
        navigate(route.AddAnnexure, { state: { aid: aid } });
    };
                ...
                <div className="action-table-data">
                    <div className="edit-delete-action">
                        <OverlayTrigger placement="top" overlay={<Tooltip id="edit-tooltip">Edit</Tooltip>}>
                            <a className="me-2 p-2" onClick={() => onEditClick(record.aid)}>
                        ...
                        <OverlayTrigger placement="top" overlay={<Tooltip id="delete-tooltip">Delete</Tooltip>}>
                            <Link
                                ...
                                to="#"
                                onClick={() => showConfirmationAlert(record.aid)}
                            >
    ...
    const OndeleteAccounts = async (aid) => {
        try {
            const payload = {
                aid: aid,
                companyid: "",
            ...
            const response = await axios.post(
                `${baseUrl.Url}/api/SP_DeleteAnnexFile`,
                payload,
                { headers }
            );
            ...
            setAnnexure((prevState) => prevState.filter((item) => item.aid !== aid));
        } catch (error) {
    ...
    const showConfirmationAlert = (aid) => {
        MySwal.fire({
            title: "Are you sure?",
                ...
                <div className="page-header">
                    <div className="add-item d-flex">
                        <div className="page-title">
                            <h3>ॲनेक्स्चर मास्टर</h3>
                        </div>
                    </div>
                    <ul className="table-top-head">
                        <li>
                            <OverlayTrigger placement="top" overlay={renderTooltip}>
                                <Link onClick={() => generatePDF(GrapesList)}>
                    ...
                    <div className="page-btn">
                        <Link to={route.AddAnnexure} className="btn btn-added">
                            <PlusCircle className="me-2 iconsize" /> नवीन सूची
                        </Link>
                    </div>
                    <div className="page-btn">
                ...
                <div className="card table-list-card">
                    <div className="card-body">
                        <div className="table-responsive">
                            <Table columns={columns} dataSource={Annexure} />
                        </div>
                    </div>
                </div>
