...
function OnEditQuatation({ QAMAID, praid, caid, CSTATE }) {
    console.log(praid, caid, QAMAID, CSTATE)
            ...
            axios({
                ...
                .then((response) => {
                    ...
                    setFormData(prev => ({
                        ...
                        QAMAID: apiData.qamaid,
                        QNO: apiData.qno,
                        QDATE: convertToISODate(apiData.qdate),
                        requisition_no: apiData.prno,
                        QDUEDATE: convertToISODate(apiData.qduedate),
                        QVAID: apiData.qvaid,
                        QVCONTACT: apiData.qvcontact,
                        QVEMAIL: apiData.qvemail,
                        QVADDRESS: apiData.qvaddress,
                        ...
                        BankName: apiData.cbankname,
                        AccountNumber: apiData.caccountnumber,
                        IFSCCode: apiData.cifsc,
                        BranchName: apiData.cbranchname,
                        ppreff: apiData.prreff,
                        isapproved: apiData.isapproved,
                        QVAIDID: apiData.qvaid,
                    }));
    ...
    const showConfirmationAlert = (event) => {
        try {
            ...
            axios({
                method: "POST",
                url: baseUrl.Url + "/backend/api/SP_MeassageQuatation",
                data: JSON.stringify(payload),
                headers: headers,
            })
                .then((response) => {
    ...
    const handleFormSubmission = async () => {
        try {
            const payload = {
                qamaid: (QAMAID !== '' && QAMAID !== undefined) ? QAMAID : GUID,
                ...
                prreff: formData.ppreff !== '' ? formData.ppreff : praid,
            ...
            if (response1.status === 200) {
                const detailPayload = products
                    .filter(product => product.qrate > 0)
                    .map(product => ({
                        qamdaid: (product.qamdaid !== '' && product.qamdaid !== undefined) ? product.qamdaid : ACSPLGUID.getNew(),
                        qamaid: (QAMAID !== '' && QAMAID !== undefined) ? QAMAID : GUID,
                        qproduct: product.qproduct,
                        qquantity: product.qquantity,
                        quom: product.quom,
                        qrate: product.qrate,
                        qtamt: product.qtamt,
                        qigst: product.qigst,
                                                                            ...
                                                                            <tr key={index}>
                                                                                ...
                                                                                <td className="col-1" style={{ padding: "5px 10px" }}>
                                                                                    <input
                                                                                        ...
                                                                                        onChange={(e) => handleProductChange(e, index, "qrate")}
                                                                                        style={{ height: "30px" }}
                                                                                ...
                                                                                <td className="col-1" style={{ padding: "5px 10px" }}>
                                                                                    <input
                                                                                        value={product.qcgst}
                                                                                        className="form-control form-control-sm border-0 border-bottom border-primary"
                                                                                        onChange={(e) => handleProductChange(e, index, "qcgst")}
                                                                                        style={{ height: "30px" }}
                                                                                        readOnly={formData.QVADDRESS !== userdetail?.companystate}
                                                                                    />
                                                                                </td>
                                                                                <td className="col-1" style={{ padding: "5px 10px" }}>
                                                                                    <input
                                                                                        value={product.qsgst}
                                                                                        className="form-control form-control-sm border-0 border-bottom border-primary"
                                                                                        onChange={(e) => handleProductChange(e, index, "qsgst")}
                                                                                        style={{ height: "30px" }}
                                                                                        readOnly={formData.QVADDRESS !== userdetail?.companystate}
                                                                                    />
                                                                                </td>
                                                                                <td className="col-1" style={{ padding: "5px 10px" }}>
                                                                                    <input
                                                                                        value={product.qigst}
                                                                                        className="form-control form-control-sm border-0 border-bottom border-primary"
                                                                                        onChange={(e) => handleProductChange(e, index, "qigst")}
                                                                                        style={{ height: "30px" }}
                                                                                        readOnly={formData.QVADDRESS !== userdetail?.companystate}
                                                                                    />
                                                                                </td>
...
export default OnEditQuatation
