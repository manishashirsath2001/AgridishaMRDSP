...
import AddSaleQuotation from "./AddSalesQuotation";
...
const QuotationMaster = () => {
    ...
    const handleSearch = (event) => {
        ...
        try {
            ...
            axios({
                method: "POST",
                url: baseUrl.Url + "/backend/api/GET_SQuatationMaster/_Search",
                data: JSON.stringify(payload),
                headers: headers,
            })
        ...
        },
        {
            title: (
                <OverlayTrigger placement="top" overlay={<Tooltip id="quotation_date-tooltip">Quotation Date</Tooltip>}>
                    <span style={{ display: 'block', textAlign: 'center', width: '100%' }}>कोटेशन तारीख</span>
                </OverlayTrigger>
            ),
            dataIndex: "sqdate",
            render: (text) => (
...

        {
            title: (
                <OverlayTrigger placement="top" overlay={<Tooltip id="quotation_due_date-tooltip">Quotation Due Date</Tooltip>}>
                    <span style={{ display: 'block', textAlign: 'center', width: '100%' }}>कोटेशनाची देय तारीख</span>
                </OverlayTrigger>
            ),
            dataIndex: "sqduedate",
            render: (text) => (
                    ...
                    <div className="edit-delete-action">
                        ...
                        >
                            <Link className="me-2 p-2"
                                ...
                                data-bs-target="#AddSaleQuotation"
    ...
    const exportToExcel = async () => {
        try {
            ...
            const columnWidths = [20, 25, 30, 35, 22]; // Adjust widths as needed
    ...
    return (
        <div className="page-wrapper">
            <div className="content">
                <div className="page-header">
                    ...
                    <div className="d-flex purchase-pg-btn">
                        ...
                        <div className="page-btn">
                            <Link to={route.QuotationIndex} className="btn btn-secondary">
            ...
            <AddSaleQuotation SQAMAID={selectedData.sqamaid} />
            <EditPurchases />
