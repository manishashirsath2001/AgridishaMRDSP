...
const AddCashVyaparibharana = ({ onClose, BHARALELIRAKKAM }) => {

    console.log(BHARALELIRAKKAM, "BHARALELIRAKKAM!!!!!!!!!");
    ...
    const Validation = (e) => {
        ...
        const expectedTotal = Math.floor(BHARALELIRAKKAM);
...
export default AddCashVyaparibharana;
...
// import { ACSPLGUID, baseUrl } from "../../core/json/custom";
// import { getUserData } from '../../Context/UserData';
// const AddCash = ({ onClose, BHARALELIRAKKAM }) => {
