...
import AddDirectsalechallan from "./AddDirectSaleChallan";
...
const Directsalechallan = () => {
    ...
    const handleSearch = (event) => {
        ...
        try {
            ...
            axios({
                method: "POST",
                url: baseUrl.Url + "/backend/api/GET_SChallanMaster/_Search",
    ...
    const columns = [
        ...
        },
        {
            title: (
                <OverlayTrigger
                    placement="top"
                    overlay={<Tooltip id="types-tooltip">पूरवठा ठीकाण</Tooltip>}
                >
        ...
        },
        {
            title: (
                ...
                >
                    <div className="text-center">ग्राहकाचे नाव</div>
                </OverlayTrigger>
            ),
        ...
        },
        {
            title: (
                ...
                >
                    <div className="text-center">कर मूल्य</div>
                </OverlayTrigger>
            ),
            dataIndex: "scgamt",
            width: 110,
                    ...
                    <div className="edit-delete-action">
                        ...
                        >
                            <Link className="me-2 p-2"
                                ...
                                data-bs-target="#AddDirectsalechallan"
                        ...
                        >
                            <Link className="me-2 p-2" to="#" data-bs-toggle="modal" data-bs-target="#Addpicksale" style={{ color: 'green' }}>
    ...
    return (
        <div className="page-wrapper">
            ...
            {/* <AddPurchases /> */}
            {/* <Addpicksale /> */}
            <AddDirectsalechallan
                SCAID={selectedData.scaid} />
        </div>
    );
};
export default Directsalechallan;
